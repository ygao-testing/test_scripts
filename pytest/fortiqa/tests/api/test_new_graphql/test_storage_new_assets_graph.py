...
from fortiqa.libs.lw.apiv1.payloads import GraphQLFilter, ComparisonOperator, ResourceGroups, StorageResourceTypesV2
...
def test_search_storage_assets_by_severity(api_v1_client, severity, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Risk Score->Severity

    Given: API V1 Client, and a list of severity
    When: Call NewGraphQL API, using filter Storage Assets->Risk Score->Severity
    ...
    query = GraphQLFilter(type='STORAGE_RESOURCE')
...
def test_search_storage_assets_by_score(api_v1_client, operator, risk_score, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Risk Score->Score

    Given: API V1 Client, comparision operator and risk score
    When: Call NewGraphQL API, using filter Storage Assets->Risk Score->Severity->Critical and High
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_cloud_service_provider(api_v1_client, cloud_provider, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Cloud Service Provider

    Given: API V1 Client, and a list of cloud service providers
    When: Call NewGraphQL API, using filter Storage Assets->Cloud Service Provider
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_account_alias(api_v1_client, operator, account_alias, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Accounts->Account Alias

    Given: API V1 Client, comparision operator and account_alias
    When: Call NewGraphQL API, using filter Storage Assets->Accounts->Account Alias
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_account_id(api_v1_client, operator, account_id, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Accounts->Account ID

    Given: API V1 Client, comparision operator and account_id
    When: Call NewGraphQL API, using filter Storage Assets->Accounts->Account ID
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_organization_id(api_v1_client, operator, organization_id, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Accounts->Organization ID
    Given: API V1 Client, comparision operator and organization_id
    When: Call NewGraphQL API, using filter Storage Assets->Accounts->Organization ID
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_uniform_resource_name(api_v1_client, operator, uniform_resource_name, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Accounts->Uniform Resource Name
    Given: API V1 Client, comparision operator and uniform_resource_name
    When: Call NewGraphQL API, using filter Storage Assets->Accounts->Uniform Resource Name
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_tag_value(api_v1_client, tag_key_pair, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Tags

    Given: API V1 Client, and a list of tag name_value pairs
    When: Call NewGraphQL API, using filter Storage Assets->Tags
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_alert_by_alert_id(api_v1_client, alert_id, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Alerts>Alert ID

    Given: API V1 Client, and alert_id
    When: Call NewGraphQL API, using filter Storage Assets->Alerts>Alert ID
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_alert_by_severity(api_v1_client, severity, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Alerts>Severity

    Given: API V1 Client, and severity
    When: Call NewGraphQL API, using filter Storage Assets->Alerts>Severity
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_compliance_by_alert_id(api_v1_client, rule_id, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Compliance Violation->Rule ID

    Given: API V1 Client, and rule_id
    When: Call NewGraphQL API, using filter Storage Assets->Compliance Violation->Rule ID
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_compliance_by_severity(api_v1_client, severity, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Compliance Violation->Severity

    Given: API V1 Client, and severity
    When: Call NewGraphQL API, using filter Storage Assets->Compliance Violation->Severity
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_resource_id(api_v1_client, operator, resource_id, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Resource ID

    Given: API V1 Client, comparision operator and resource_id
    When: Call NewGraphQL API, using filter Storage Assets->Resource ID
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_resource_name(api_v1_client, operator, resource_name, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Resource Name

    Given: API V1 Client, comparision operator and resource_name
    When: Call NewGraphQL API, using filter Storage Assets->Resource Name
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_resource_group(api_v1_client, resource_group, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Resource Groups

    Given: API V1 Client, and a list of resource_groups
    When: Call NewGraphQL API, using filter Storage Assets->Resource Groups
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_internet_expose(api_v1_client, internet_exposed, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Internet Exposed

    Given: API V1 Client, comparision operator and internet_exposed option
    When: Call NewGraphQL API, using filter Storage Assets->Internet Exposed
    Then: Expect status code returned is 200, and no Error message returned
...
def test_search_storage_assets_by_has_attack_path(api_v1_client, has_attack_path, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from Storage Assets->Attack Path

    Given: API V1 Client, comparision operator and has_attack_path option
    When: Call NewGraphQL API, using filter Storage Assets->Attack Path
    Then: Expect status code returned is 200, and no Error message returned
...
@pytest.mark.parametrize("resource_type", [StorageResourceTypesV2.all_resource_types()])
def test_search_storage_assets_by_resource_type(api_v1_client, resource_type, get_explorer_time_range):
    """
    Verify that NewGraphQL API returns status code 200 from STORAGE_RESOURCE->Resource Type

    Given: API V1 Client, and resource_type list
    When: Call NewGraphQL API, using filter STORAGE_RESOURCE->Resource Type
    Then: Expect status code returned is 200, and no Error message returned
