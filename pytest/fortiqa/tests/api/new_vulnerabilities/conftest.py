...
def generate_new_vuln_payload_and_query(api_v1_client, query_object, query_type):
    """
    ...
    generated_payload = new_vuln_api.generate_payload(new_vuln_object=query_object)
    if query_type == "host":
