...
@pytest.fixture(scope='package')
def linux_agent_hosts(linux_agent_token_with_caa_vulnwatch, agents_tf_root, aws_env_variables):
    """Fixture applies all TF modules for linux agents."""
    hosts = {}
    try:
        os.environ['TF_VAR_AGENT_DOWNLOAD_URL'] = f"https://fortiqa.lacework.net/mgr/v1/download/{linux_agent_token_with_caa_vulnwatch}/install.sh" # noqa
