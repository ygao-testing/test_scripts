...
%{ endif }
  ...
  - sleep 10
  - docker pull rockylinux/rockylinux:9.4
  - docker tag rockylinux/rockylinux:9.4 rockylinux/rockylinux:rocky9.4
  - docker run -dit --name test_container docker.io/rockylinux/rockylinux:9.4
