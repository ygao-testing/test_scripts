...
"0.5 Apply workaround on Win2016 to avoid 'Invoke-WebRequest : The underlying connection was closed: An unexpected error occurred on a send.'" | Out-File -FilePath $log_path -Append
